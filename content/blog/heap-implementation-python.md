---
title: A heap implementation in Python
description: One more python implementation of a data structure. This is a heap implementation that follows an architecture similar to the binary search tree we have built earlier.
date_created: 2014-09-09
---
