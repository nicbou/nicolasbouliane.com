...
What do you do if you can't open a bank account because you can't get a [tax ID](https://allaboutberlin.com/guides/german-tax-id-steuernummer)
...
I do it out of a [duty to document](/blog/duty-to-document). I figure that if information is cheap and disproportionately valuable, and that it takes a few minutes to publish text online, and that it can help thousands of people, it would be selfish to keep it to myself.
...
I assume that my readers arrived in Germany yesterday, speak no German, and don't know what a [Wohnungsgeberbestätigung](https://allaboutberlin.com/glossary/Wohnungsgeberbest%C3%A4tigung) is.
...
I use images sparingly, but when it helps, I create my own graphics. I release most of them [in the public domain](https://commons.wikimedia.org/w/index.php?title=Special:ListFiles/Nicbou&ilshowall=1).

![All About Berlin graphics](/images/aab-graphics.png)

I also create my own letter templates. I know that writing a letter in a foreign language is daunting for many, and that it can add a lot of friction to the process. These template generators create templates in English and German, and help people fill in the blanks. They get used thousands of times per month. That's hundreds of hours saved.
...
I have set up a lot of infrastructure to keep my guides up to date. I monitor hundreds of pages and legal texts for changes with [Wachete](https://www.wachete.com/). When something changes, I get an email that shows the differences. I update my content within a few hours.
